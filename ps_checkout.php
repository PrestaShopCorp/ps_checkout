    ...
    public function hookActionFrontControllerSetMedia()
    {
        ...
        Media::addJsDef([
            ...
            $this->name . 'CheckoutTranslations' => [
                ...
                'checkout.form.card.number.label' => $this->l('Card number'),
                'checkout.form.card.number.placeholder' => $this->l('Card number'),
                'checkout.form.expiry.date.label' => $this->l('Expiry date'),
                'checkout.form.expiry.date.placeholder' => $this->l('MM/YY'),
                'checkout.form.cvc.label' => $this->l('CVC'),
                'checkout.form.cvc.placeholder' => $this->l('XXX'),
