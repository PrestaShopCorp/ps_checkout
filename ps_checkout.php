...
class Ps_checkout extends PaymentModule
{
    ...
    public $configurationList = [
        ...
        'PS_CHECKOUT_PAY_IN_4X_PRODUCT_PAGE' => true,
        'PS_CHECKOUT_PAY_IN_4X_ORDER_PAGE' => true,
        'PS_CHECKOUT_PAY_IN_4X_PRODUCT_PAGE_BUTTON' => true,
        'PS_CHECKOUT_PAY_IN_4X_ORDER_PAGE_BUTTON' => true,
        'PS_CHECKOUT_PAY_IN_4X_CART_PAGE_BUTTON' => true,
