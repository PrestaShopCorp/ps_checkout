...
class ApplePayEligibilityChecker extends BaseFundingSourceEligibilityChecker
{
    ...
    {
        return ['AU', 'AT', 'BE', 'BG', 'CA', 'CN', 'CY', 'CZ', 'DK', 'EE', 'FI', 'FR', 'DE', 'GR', 'HU', 'IE', 'IT', 'LV', 'LI', 'LT', 'LU', 'MT', 'NL', 'NO', 'PL', 'PT', 'RO', 'SK', 'SI', 'ES', 'SE', 'GB', 'US'];
    }
    ...
    {
        $configuration = $this->configuration->get(PayPalConfiguration::PS_CHECKOUT_PAYMENT_MODE) === PayPalConfiguration::MODE_SANDBOX ?
