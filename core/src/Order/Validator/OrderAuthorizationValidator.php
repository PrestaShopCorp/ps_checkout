...
class OrderAuthorizationValidator implements OrderAuthorizationValidatorInterface
{
    ...
    {
        if ($payPalOrder->getStatus() === 'COMPLETED' && $payPalOrder->getFundingSource() !== 'pay_upon_invoice') {
        ...
        if ($payPalOrder->getFundingSource() !== 'pay_upon_invoice' && $payPalOrder->getStatus() !== 'PENDING_APPROVAL') {
