...
class OrderAmountValidator implements OrderAmountValidatorInterface
{
    // The order was paid
     ...
     * {@inheritDoc}
     */
    public function validate(string $totalAmount, string $totalAmountPaid): int
    {
