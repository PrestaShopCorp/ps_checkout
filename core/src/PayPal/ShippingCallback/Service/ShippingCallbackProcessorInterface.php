...
namespace PsCheckout\Core\PayPal\ShippingCallback\Service;
...
interface ShippingCallbackProcessorInterface
{
    /**
     * Process a PayPal shipping callback and return the merchant response array.
     *
     * @throws ShippingCallbackException
     *
