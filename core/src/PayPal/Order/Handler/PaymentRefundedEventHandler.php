...
class PaymentRefundedEventHandler implements EventHandlerInterface
{
    /**
    ...
    public function __construct(SetOrderStateActionInterface $setRefundedOrderStateAction)
    {
    ...
    {
        $this->setRefundedOrderStateAction->execute($payPalOrderResponse->getId());
    }
}
