...
class PayPalOrderRefund
{
     ...
     * @return PayPalOrderRefund
     */
    public function setAcquirerReferenceNumber($acquirerReferenceNumber): self
    {
        $this->acquirerReferenceNumber = $acquirerReferenceNumber;
     ...
     * @return PayPalOrderRefund
     */
    public function setSellerPayableBreakdown(array $sellerPayableBreakdown): self
    {
        $this->sellerPayableBreakdown = $sellerPayableBreakdown;
    ...
    /**
     * @param int|null $idOrderSlip
     *
     * @return PayPalOrderRefund
     */
    public function setIdOrderSlip($idOrderSlip): self
    {
