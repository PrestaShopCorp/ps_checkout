...
interface TrackingCarrierModuleNodeBuilderInterface
{
    /**
     * Set carrier name other
     *
     * @param string $carrierNameOther
     *
     * @return TrackingCarrierModuleNodeBuilderInterface
     */
    ...
    /**
     * Build the carrier module payload
     *
     * @return array
     */
