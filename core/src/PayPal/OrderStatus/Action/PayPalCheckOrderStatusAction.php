...
namespace PsCheckout\Core\PayPal\OrderStatus\Action;

use PsCheckout\Core\Order\Exception\OrderException;
use PsCheckout\Core\PayPal\Order\Configuration\PayPalOrderStatus;

class PayPalCheckOrderStatusAction implements PayPalCheckOrderStatusActionInterface
{
    /**
     * {@inheritdoc}
     */
    public function execute(string $oldStatus, string $newStatus): bool
    {
