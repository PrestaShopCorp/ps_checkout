...
interface ApplePayNodeBuilderInterface
{
    /**
     * Build a partial Apple Pay payment request array.
     * Returns an empty array when the feature is disabled or data is insufficient.
     *
