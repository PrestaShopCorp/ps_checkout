...
namespace PsCheckout\Core\OrderState\Configuration;
...
class OrderStateConfiguration
{
    ...
    const PS_CHECKOUT_ORDER_STATUS_AUTH_CAPTURE = 'PS_CHECKOUT_ORDER_STATUS_AUTH_CAPTURE';

    const PS_CHECKOUT_STATE_VOIDED = 'PS_CHECKOUT_STATE_VOIDED';
}
