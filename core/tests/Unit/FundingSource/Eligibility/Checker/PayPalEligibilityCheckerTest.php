...
/**
 * @coversDefaultClass \PsCheckout\Core\FundingSource\Eligibility\Checker\PayPalEligibilityChecker
 */
class PayPalEligibilityCheckerTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->checker = new PayPalEligibilityChecker(
            $this->context,
            $this->configuration,
    ...
    {
        self::assertTrue($this->checker->supports(new FundingSource('paypal', 'PayPal', 0, true, null)));
    }
    ...
    public function testIsEligibleWithSupportedCurrencyAndCaptureIntent(string $currency): void
    {
        ...
        self::assertTrue($this->checker->isEligible(new FundingSource('paypal', 'PayPal', 0, true, null)));
    }
    ...
    public function testIsNotEligibleWithUnsupportedCurrency(): void
    {
        ...
        self::assertFalse($this->checker->isEligible(new FundingSource('paypal', 'PayPal', 0, true, null)));
    }
