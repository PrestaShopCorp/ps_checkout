...
/**
 * Update main function for module version 7.5.3.0
 *
 * @param Ps_checkout $module
 *
 * @return bool
 */
function upgrade_module_7_5_3_0(Ps_checkout $module)
{
    try {
        $db = Db::getInstance();
    ...
    try {
        ...
        if ($needsCreation) {
            ps_checkout_create_order_state_7_5_3_0(
...
function ps_checkout_create_order_state_7_5_3_0($configuration_key, $color, $nameByLangIsoCode)
{
