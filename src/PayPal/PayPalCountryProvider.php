...
//    const COUNTRIES = [['iso_code' => 'ZW'], ['iso_code' => 'ZM'], ['iso_code' => 'YE']];
    ...
    public function getByCode($code)
    {
        ...
        throw new PsCheckoutException(sprintf('Unsupported country code, given %s', var_export($code, true)), PsCheckoutException::PSCHECKOUT_SHIPPING_COUNTRY_CODE_INVALID);
    }
}
