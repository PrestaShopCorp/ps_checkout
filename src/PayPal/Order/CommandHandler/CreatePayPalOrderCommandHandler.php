...
class CreatePayPalOrderCommandHandler
{
    ...
    public function handle(CreatePayPalOrderCommand $command)
    {
        ...
        $order = $this->createPayPalOrderHandler->createOrder($payload);
