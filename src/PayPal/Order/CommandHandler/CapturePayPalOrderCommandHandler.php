    ...
    public function handle(CapturePayPalOrderCommand $capturePayPalOrderCommand)
    {
        try {
            ...
            $response = $apiOrder->capture(
                $capturePayPalOrderCommand->getOrderId(),
                $merchantId,
            ...
            throw new PayPalOrderException(sprintf('Unable to capture PayPal Order #%d', $capturePayPalOrderCommand->getOrderId()), PayPalOrderException::CANNOT_CAPTURE_ORDER, $exception);
        }
    }
}
