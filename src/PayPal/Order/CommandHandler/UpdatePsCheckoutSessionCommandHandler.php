...
use SebastianBergmann\CodeUnitReverseLookup\WizardTest;
...
class UpdatePsCheckoutSessionCommandHandler
{
    ...
    public function handle(UpdatePsCheckoutSessionCommand $updatePsCheckoutSessionCommand)
    {
        try {
            ...
            throw new PayPalOrderException(sprintf('Unable to capture PayPal Order #%d', $updatePsCheckoutSessionCommand->getOrderId()->getValue()), PsCheckoutException::SESSION_EXCEPTION, $exception);
        }
