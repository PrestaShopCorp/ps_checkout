...
class GetPayPalOrderForCartIdQueryResult
{
    /**
     * @var array
     */
    ...
    /**
     * @return array{id: string, status: string, intent: string, payment_source: array, purchase_units: array, payer: array, create_time: string, links: array}
     */
