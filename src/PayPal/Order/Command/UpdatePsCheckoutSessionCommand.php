...
class UpdatePsCheckoutSessionCommand{
     ...
     */
    public function __construct($orderId, $id_cart, $fundingSource,$paypal_intent,$paypal_status,$paypal_token,$paypal_token_expire,$paypal_authorization_expire,$isHostedFields,$isExpressCheckout)
    {
        $this->orderId = new PayPalOrderId($orderId);
        $this->id_cart = new CartId($id_cart);
