...
class CheckTransitionPayPalOrderStatusService
{
    /**
     * @param $oldStatus
     * @param $newStatus
    ...
    public function checkAvailableStatus($oldStatus, $newStatus): bool
    {
        ...
        if (!isset(PayPalOrderStatus::STATUS_AVAILABLE[$oldStatus])) {
        ...
        return in_array($newStatus, PayPalOrderStatus::STATUS_AVAILABLE[$oldStatus]);
    }
}
