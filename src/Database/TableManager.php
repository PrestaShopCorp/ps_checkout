...
class TableManager
{
    ...
    {
        return $this->db->execute('DROP TABLE IF EXISTS `' . _DB_PREFIX_ . 'pscheckout_onboarding_session`') &&
          $this->db->execute('DROP TABLE IF EXISTS `' . _DB_PREFIX_ . 'pscheckout_payment_session`') &&
