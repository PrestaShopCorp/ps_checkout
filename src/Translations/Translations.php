        ...
        $translations[$locale] = [
            ...
            'panel' => [
                ...
                'payment-method-activation' => [
                    ...
                    'popover-difference-answer' => $this->module->l('Intergrated Credit Card fields provide the best payment experience you can find in PrestaShop. Well integrated in your checkout process, not branded, with the fewest number of fields, and lowest fee rates (see them on prestashop.com/en/prestahop-checkout) : we highly recommend to use these ones, by default. But you need PayPal full approval for accepting Credit Cards payment with the fields. You can see the status of this approval in the Authentication tab [Lien vers onglet]', 'translations'),
