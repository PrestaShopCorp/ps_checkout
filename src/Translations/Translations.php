    ...
    public function getTranslations()
    {
        ...
        $translations[$locale] = [
            'modal' => [
                ...
                'capture' => [
                    'title' => 'Switch to Authorize Mode ?',
            ...
            'panel' => [
                ...
                'payment-mode' => [
                    ...
                    'authorize' => $this->module->l('Authorize', 'translations'),
                    'tipdirectsale-question' => $this->module->l('When use Direct Sale ?', 'translations'),
                    'tipdirectsale-answer' => $this->module->l('This feature will debit buyer bank account and credit your PayPal account for every successful order. This is the regular mode to process your orders.', 'translations'),
                    'tipcapture-question' => $this->module->l('When use Authorize ?', 'translations'),
                    'tipcapture-answer' => $this->module->l('This feature holds the payment before shipping. You can capture the money anytime by going to the Order page. That mode could be useful if you have a complex stock management system.', 'translations'),
