...
class CheckTransitionStateService
{
        ...
        switch ($data['PayPalOrder']['newStatus']) {
            case PayPalOrderStatus::COMPLETED:
                if (isset($data['PayPalCapture'])) {
                    ...
                    $state = isset(self::STATES['PayPalAuthorization'][$data['PayPalAuthorization']['status']]) ? self::STATES['PayPalAuthorization'][$data['PayPalAuthorization']['status']] : false;
                } elseif (isset($data['PayPalRefund'])) {
                    $state = isset(self::STATES['PayPalRefund'][$data['PayPalRefund']['status']]) ? self::STATES['PayPalRefund'][$data['PayPalRefund']['status']] : false;
                }
                break;
            default:
     ...
     *
     * @throws \PrestaShop\Module\PrestashopCheckout\Order\Exception\OrderException
     */
