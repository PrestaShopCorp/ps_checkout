        ...
        $translations[$locale] = array(
            ...
            'pages' => array(
                'accounts' => array(
                    ...
                    'additionalDocumentsNeeded' => $this->module->l('Additional information is required to complete background check. Please upload the following document(s):', 'translations'),
                    'photoIds' => $this->module->l('Photo IDs, such as driving licence, for all beneficial owners', 'translations'),
                    'uploadFile' => $this->module->l('Upload file(s)', 'translations'),
                    'undergoingCheck' => $this->module->l('Background check is currently undergoing', 'translations'),
                    'severalDays' => $this->module->l('It can take several days. If further information is needed, you will be notified.', 'translations'),
