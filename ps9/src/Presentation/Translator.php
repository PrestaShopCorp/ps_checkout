...
class Translator implements TranslatorInterface
{
    ...
    public function trans(string $key, array $parameters = []): string
    {
        $map = [
            ...
            'PayPal Order is invalid.' => $this->translator->trans('PayPal Order is invalid.', $parameters, 'Modules.Checkout.Pscheckout.order'),
            'PayPal Transaction is invalid.' => $this->translator->trans('PayPal Transaction is invalid.', $parameters, 'Modules.Checkout.Pscheckout.order'),
            'PayPal refund currency is invalid.' => $this->translator->trans('PayPal refund currency is invalid.', $parameters, 'Modules.Checkout.Pscheckout.order'),
            'PayPal refund amount is invalid.' => $this->translator->trans('PayPal refund amount is invalid.', $parameters, 'Modules.Checkout.Pscheckout.order'),
            'PayPal refund failed.' => $this->translator->trans('PayPal refund failed.', $parameters, 'Modules.Checkout.Pscheckout.order'),
            'Refund has been processed by PayPal, but order status change or email sending failed.' => $this->translator->trans('Refund has been processed by PayPal, but order status change or email sending failed.', $parameters, 'Modules.Checkout.Pscheckout.order'),
            'Refund cannot be processed by PayPal.' => $this->translator->trans('Refund cannot be processed by PayPal.', $parameters, 'Modules.Checkout.Pscheckout.order'),
            'Refund has been processed by PayPal.' => $this->translator->trans('Refund has been processed by PayPal.', $parameters, 'Modules.Checkout.Pscheckout.order'),
            'No PrestaShop Order identifier received' => $this->translator->trans('No PrestaShop Order identifier received', $parameters, 'Modules.Checkout.Pscheckout.order'),
            'Unable to find PayPal Order associated to this PrestaShop Order %s' => $this->translator->trans('Unable to find PayPal Order associated to this PrestaShop Order %s', $parameters, 'Modules.Checkout.Pscheckout.order'),
            'PayPal Order %s is not in the same environment as PrestaShop Checkout' => $this->translator->trans('PayPal Order %s is not in the same environment as PrestaShop Checkout', $parameters, 'Modules.Checkout.Pscheckout.order'),
