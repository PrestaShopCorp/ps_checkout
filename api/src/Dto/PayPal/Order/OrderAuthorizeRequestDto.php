...
use PsCheckout\Api\Dto\PayPal\OrderAuthorizeRequestPaymentSource;

/**
 * The authorization of an order request.
 */
class OrderAuthorizeRequestDto
{
    /**
     ...
     * @return self
     */
    public function setPaymentSource(?OrderAuthorizeRequestPaymentSource $paymentSource): self
    {
