...
use PsCheckout\Api\Dto\PayPal\OrderAuthorizeResponsePaymentSource;
 ...
 */
class OrderAuthorizeResponseDto
{
    /**
     * @var string|null
     */
     ...
     * @return self
     */
    public function setPaymentSource(?OrderAuthorizeResponsePaymentSource $paymentSource): self
    {
