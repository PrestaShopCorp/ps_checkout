...
use PsCheckout\Api\Dto\PayPal\CaptureStatus;
use PsCheckout\Api\Dto\PayPal\CaptureStatusDetails;
...
use PsCheckout\Api\Dto\PayPal\ProcessorResponse;
use PsCheckout\Api\Dto\PayPal\SellerProtection;
use PsCheckout\Api\Dto\PayPal\SellerReceivableBreakdown;
...
{
    /**
     * @var value-of<CaptureStatus::STATUSES>|null
     */
    private $status;
     ...
     *
     * @return value-of<CaptureStatus::STATUSES>|null
     */
     ...
     * The status of the captured payment.
     *
     * @param value-of<CaptureStatus::STATUSES>|null $status
     *
     * @maps status
     * @return self
     */
