...
use PsCheckout\Api\Http\MaaslandOrderHttpClient;
use PsCheckout\Api\Http\PsrHttpClientAdapter;
use Psr\Http\Client\ClientInterface;

class MaaslandOrderHttpClientTest extends TestCase
{
    ...
    private function createClient(ClientInterface $psrClient): MaaslandOrderHttpClient
    {
        ...
        $httpClient = new MaaslandOrderHttpClient($configurationBuilder);
